...
public class EonsFruitingLeavesBlock extends LeavesBlock implements IGrowable {
    ...
    /** */
    protected SoundEvent getPickSound() {return this.pickSound;}

    /** */
    protected Item getFruitItem() {return this.fruitItem;}
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if(ripe > 1) {
            ...
            worldIn.playSound((PlayerEntity)null, pos, this.getPickSound(), SoundCategory.BLOCKS, 1.0F, 0.8F + worldIn.rand.nextFloat() * 0.4F);
    ...
    /** */
    @Override
    public boolean canUseBonemeal(World worldIn, Random rand, BlockPos pos, BlockState state) {return false;}
