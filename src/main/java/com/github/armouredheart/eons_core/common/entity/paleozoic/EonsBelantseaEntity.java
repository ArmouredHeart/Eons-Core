...
public class EonsBelantseaEntity extends EonsGroupFishEntity {
    ...
    /** */
    public EonsBelantseaEntity(final EntityType<? extends EonsGroupFishEntity> type, final World world) {
        super(type, world, Species.BELANTSEA);
    }
