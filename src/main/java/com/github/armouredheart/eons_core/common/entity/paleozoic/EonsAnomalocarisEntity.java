...
public class EonsAnomalocarisEntity extends EonsBigFishEntity implements IEonsPredator<EonsAnomalocarisEntity> {
    // *** Attributes ***
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(2, new EonsFightTargetGoal<EonsAnomalocarisEntity>(this, 5, 1.25F, false, 5));
    }
